...
nvcc -std=c++11 -ccbin=/usr/bin/g++ -c -o lib/active_shift2d.cu.o lib/active_shift2d.cu -D GOOGLE_CUDA=1 -x cu -Xcompiler -fPIC \
-I $TF_INC \
-L /usr/local/cuda/lib64/ -I /usr/local/ -I $TF_INC/external/nsync/public \
--expt-relaxed-constexpr -gencode arch=compute_35,code=sm_35 \
		-gencode arch=compute_50,code=sm_50 \
		-gencode arch=compute_50,code=compute_50

g++ -std=c++11 -shared -o lib/active_shift2d.so lib/active_shift2d.cc lib/active_shift2d.cu.o \
